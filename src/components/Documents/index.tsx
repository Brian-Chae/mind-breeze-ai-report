...
export type DocumentSection = string;
...
const Documents: React.FC = () => {
  ...
  const [activeSection, setActiveSection] = useState<DocumentSection>('getting-started');
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative bg-black border border-gray-500 rounded-lg p-2">
                ...
                <Input
                  ...
                  className="pl-10 w-64 bg-transparent border-none text-white placeholder:text-gray-400"
                />
              </div>
