...
const steps = [
  {
    icon: Brain,
    title: "Wear LINK BAND",
    description: "Simply put on the comfortable EEG headband like wearing headphones - ultra-light at only 50g",
    color: "blue",
    step: "01"
  },
  {
    icon: Timer,
    title: "1-Minute EEG Recording",
    description: "Relax for just 60 seconds while 2-channel EEG sensors capture your brain activity patterns",
    color: "green",
    step: "02"
  },
  {
    icon: FileText,
    title: "Instant AI Brain Analysis",
    description: "Receive personalized brain health insights with AI-powered EEG analysis and recommendations",
    color: "purple",
    step: "03"
  }
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
            How LINK BAND Works: Simple 3-Step EEG Process
          </h2>
